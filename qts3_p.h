...
public:
    ...
    QtS3ReplyPrivate *listObjects(const QByteArray &bucket, const QByteArray &prefix,const QByteArray &delimiter="/");
    QtS3ReplyPrivate *copyFile(const QByteArray &bucket, const QString &oldName,const QString & newName);
